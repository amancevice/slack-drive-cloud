...
resource "google_storage_bucket_object" "member_joined_channel_archive" {
  bucket = "${var.bucket_name}"
  name   = "${var.member_joined_channel_function_name}-${local.version}.zip"
